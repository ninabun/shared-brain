...
const applicationCatalog: Record<string, ApplicationConfig> = {
...
// Only active applications are exported into navigation and static route generation.
export const applications: Record<string, ApplicationConfig> = {
  "medication-verification": applicationCatalog["medication-verification"],
  "antenatal-care-companion": {
    slug:"antenatal-care-companion",title:"Antenatal Care Companion",statement:"Personalised guidance throughout the antenatal journey.",
    description:"Gestation-specific approved information, reminders and governed clinical-concern escalation.",objective:"Support pregnant women with personalised information while preserving maternity-team authority.",problem:"Pregnant women may be uncertain about schedules, investigations, symptoms and the correct route for support.",
    ai:["Understand natural-language questions","Retrieve approved gestation-specific education","Translate and summarise","Structure concern information"],n8n:["Enrol the patient","Generate the journey timeline","Schedule reminders","Validate and route concerns","Start timers and escalate","Record acknowledgement and outcome"],workflow:["Enrol","Create profile","Build timeline","Question or concern","Structure request","Validate context","Route","Human review","Respond","Record outcome"],roles:["Patient","Midwife","Doctor","Content administrator"],risk:"High",color:"#e879a7",scenario:"A fictional patient at 15 weeks asks about her morphology scan, then submits a structured bleeding concern for maternity-team review."
  }
};
